        ...
        <div class="app row app-item">
          ...
          <div class="col-sm-offset-2 col-sm-10"  style="text-align: left;">
            <div>
              ...
              <a href="/?app=lan-net-record&action=server_visit_log"><button type="button" class="btn btn-primary btn-xs"><%= ${_LANG_Form_Enter} %>&gt;</button></a>
            </div>
            <div>
			  <strong class="pull-left"><%= ${_LANG_Form_View_all_search_keywords} %>:&nbsp;&nbsp;</strong>
              <a href="/?app=lan-net-record&action=search_keyword_log"><button type="button" class="btn btn-primary btn-xs"><%= ${_LANG_Form_Enter} %>&gt;</button></a>
            </div>
            <div>
            </div>
          </div>
