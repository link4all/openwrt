          ...
          <div class="app row app-item" style="text-align: left;">
            ...
            <div class="form-group form-inline" style="margin-left: 10%">
              ...
              <div class="input-group">
                <input type="text" id="total_bw" class="form-control" size="6">
                ...
                <form id="congestion_control_form" class="form-horizontal">
                  ...
                  <div class="form-group">
                    <div class="col-md-offset-1 col-md-6">
                      ...
                      <label for="target_ip" class="control-label"><%= ${_LANG_Form_Use_non__standard_ping_target} %></label>
                    </div>
                    <div class="col-md-5">
                  ...
                  <div class="form-group">
                    <div class="col-md-offset-1 col-md-6">
                      <input type="checkbox" class="has_field">
                      <label for="ping_limit" class="control-label"><%= ${_LANG_Form_Manually_control_target_ping_time} %></label>
                    </div>
                    <div class="col-md-5">
    ...
    <div class="container">
      <div class="row">
        <div class="pull-right">
          <button class="btn btn-default btn-lg" id="page_submit"><%= ${_LANG_Form_Save_Changes} %></button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <div class="col-sm-5">
                ...
                <div class="col-sm-7">
                  <div>
                    <input type="text" class="form-control" id="source_ip" name="Source_IP" disabled required>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <div>
                    <input type="text" class="form-control" id="source_port" name="Source_Port" disabled required>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <div>
                    <input type="text" class="form-control" id="destination_ip" name="Destination_IP" disabled required>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <div>
                    <input type="text" class="form-control" id="destination_port" name="Destination_Port" disabled required>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-7 has-feedback">
                  <div class="input-group">
                    <input type="text" class="form-control" id="max_packet_length" name="Maximum_Packet_Length" disabled required>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7 has-feedback">
                  <div class="input-group">
                    <input type="text" class="form-control" id="min_packet_length" name="Minimum_Packet_Length" disabled required>
                    <span class="input-group-addon">bytes</span>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7 has-feedback">
                  <div class="input-group">
                    <input type="text" class="form-control" id="bytes_reach" name="Connection_bytes_reach" disabled required>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" id="submit_rule_btn" data-dismiss="modal"><%= ${_LANG_Form_Save_Changes} %></button>
...
<div class="modal fade" id="classModal" tabindex="-1">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <form class="form-horizontal" id="class_form">
          <fieldset>
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <div>
                  <input type="text" class="form-control" required id="service_class_name" name="name">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-7 has-feedback">
                <div class="input-group">
                  <input type="text" class="form-control" required id="percent_bandwidth" name="percent">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7 has-feedback">
                <div class="input-group">
                  <input type="text" class="form-control" id="bandwidth_min" name="min_bw" disabled>
                  <span class="input-group-addon">kbits/s</span>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-7 has-feedback">
                <div class="input-group">
                  <input type="text" class="form-control" id="bandwidth_max" name="max_bw" disabled>
                  <span class="input-group-addon">kbits/s</span>
                </div>
              </div>
            </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" id="submit_class_btn" data-dismiss="modal"><%= ${_LANG_Form_Save_Changes} %></button>
        <button type="button" class="btn btn-warning" data-dismiss="modal"><%= ${_LANG_Form_Cancel} %></button>
      </div>
    </div>
<%
        ...
        <form class="form-horizontal" id="class_form">
          <fieldset>
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <div>
                  <input type="text" class="form-control" id="service_class_name" name="name">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-7 has-feedback">
                <div class="input-group">
                  <input type="text" class="form-control" id="percent_bandwidth" name="percent">
                  <span class="input-group-addon">%</span>
                </div>
              </div>
            </div>
  ...
  <div class="col-sm-offset-1 col-sm-11 text-left">
      ...
      <div class="row">
          ...
          <div class="col-xs-9 col-sm-10 col-md-11">
              <div class="switch-ctrl head-switch" id="switch_qos_radio0">
...
%>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-default btn-block"><%= ${_LANG_Form_Save_Changes} %></button>
            </div>
        </form>
      </div>
    </div>
...
%>
	$('#switch_qos').click(function(){
		...
		if(status){
			$.post('/','app=qos-shellgui&action=total_bandwidth&up_down=all&total_bw=1',Ha.showNotify,'json');
		}else{
			$.post('/','app=qos-shellgui&action=total_bandwidth&up_down=all&total_bw=0',Ha.showNotify,'json');
		}
	});
