...
<form class="form-horizontal" name="doemail_main_setting" id="doemail_main_setting">
  <div class="form-group">
	...
	<div class="col-sm-8">
	  <input type="text" class="form-control" name="MY_NAME" id="nickname" placeholder="nickname" value="<%= ${mail_MY_NAME} %>">
	</div>
  </div>
  ...
  <div class="form-group">
	...
	<div class="col-sm-8">
	  <input type="text" class="form-control" name="MY_EMAIL" id="email" placeholder="Email" value="<%= ${mail_MY_EMAIL} %>">
	</div>
  </div>
  ...
  <div class="form-group">
	...
	<div class="col-sm-8">
	  <input type="text" class="form-control" name="SMTP_AUTH_USER" id="SMTP_AUTH_USER" placeholder="Username" value="<%= ${mail_SMTP_AUTH_USER} %>">
	</div>
  </div>
  ...
  <div class="form-group">
	...
	<div class="col-sm-8">
	  <input type="password" class="form-control" name="SMTP_AUTH_PASS" id="SMTP_AUTH_PASS" placeholder="Password" value="<%= ${mail_SMTP_AUTH_PASS} %>">
	</div>
  </div>
  ...
  <div class="form-group">
	...
	<div class="col-sm-8">
	  <input type="text" class="form-control" name="SMTP_SERVER" id="SMTP_SERVER" placeholder="SMTP Server IP" value="<%= ${mail_SMTP_SERVER} %>">
	</div>
  </div>
  ...
  <div class="form-group">
	...
	<div class="col-sm-8">
	  <input type="text" class="form-control" name="SMTP_PORT" id="SMTP_PORT" placeholder="SMTP Server Port" value="<%= ${mail_SMTP_PORT} %>">
	</div>
  </div>
  ...
  <div class="form-group">
	...
	<div class="col-sm-8">
	  <input type="text" class="form-control" name="subject" id="subject" placeholder="Default subject" value="<%= ${mail_subject} %>">
	</div>
  </div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<div class="input-group">
				<input type="text" class="form-control" id="TIMEOUT" name="TIMEOUT" placeholder="20" value="<%= ${mail_TIMEOUT} %>">
...
<form class="form-horizontal" name="email_extra_setting" id="email_extra_setting">
  ...
  <div class="form-group">
	...
	<div class="col-sm-8">
	  <input type="text" class="form-control" name="CC" id="CC" placeholder="example@example.com" value="<%= ${mail_CC} %>">
	</div>
  </div>
  <div class="form-group">
	<label for="BCC" class="col-sm-4 control-label"><%= ${_LANG_Form_Secret_copy_to} %></label>
	<div class="col-sm-8">
	  <input type="text" class="form-control" name="BCC" id="BCC" placeholder="example@example.com" value="<%= ${mail_BCC} %>">
	</div>
  </div>
...
<form class="form-horizontal" name="email_test" id="email_test">
  ...
  <div class="form-group">
	...
	<div class="col-sm-8">
	  <input type="text" class="form-control" name="Addressee" id="Addressee" placeholder="example@example.com" value="">
	</div>
  </div>
  <div class="form-group">
