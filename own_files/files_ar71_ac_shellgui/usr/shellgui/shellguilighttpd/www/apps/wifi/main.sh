            ...
            <div class="col-sm-6">
              ...
              <form class="form-horizontal" id="ssid_set_<%= ${iface} %>" name="ssid_set">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select type="text" class="form-control" name="encryption">
          ...
          <div class="row header">
            <form class="col-md-6 form-horizontal" id="wifi_set_<%= ${nic} %>" name="wifi_set">
              <div class="form-group">
                <label for="channel_<%= ${nic} %>" class="col-sm-3 control-label"><%= ${_LANG_Form_Channel} %></label>
                <div class="col-sm-9">
                  <select type="text" class="form-control 5g_channel" name="channel" id="channel_<%= ${nic} %>">
              ...
              <div class="form-group" id="ht_container_<%= ${nic} %>">
                <label for="ht_<%= ${nic} %>" class="col-sm-3 control-label"><%= ${_LANG_Form_Htmode} %></label>
                <div class="col-sm-9">
                  <select type="text" class="form-control" name="ht" id="ht_<%= ${nic} %>">
					<option value="20M" <% echo ${htmode} | grep -q 20 && printf 'selected="selected"' %>>20M</option>
                    <option value="40M" <% echo ${htmode} | grep -q 40 && printf 'selected="selected"' %>>40M</option>
                    <option value="80M" <% echo ${htmode} | grep -q 80 && printf 'selected="selected"' %>>80M</option>
                  </select>
                </div>
              </div>
              <div class="form-group">
