                    ...
                    <div class="col-sm-offset-1 col-sm-6">
                        <div>
                            ...
                            <div class="form-group">
                                <input class="form-control" name="hostname" placeholder="<%= ${_LANG_Form_Plz_input_host_name} %>" value="<% uci get system.@system[0].hostname %>">
							</div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-default btn-block"><%= $_LANG_Form_Save %></button>
                            </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-offset-1 col-sm-6">
                        <table class="table-hover table">
                            <tr>
                                ...
                                <td><% grep "system type" /proc/cpuinfo | cut -d ":" -f2- %></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>BogoMIPS</th>
                                <td><% grep "BogoMIPS" /proc/cpuinfo | cut -d ":" -f2- %></td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="col-sm-offset-1 col-sm-6">
                        <table class="table-hover table">
                            <tr>
                                ...
                                <td>
<%
df -h | grep ' /$' | sed -n 1p | while read rootfs total used ava used_p mounton; do
...
%>
<input type="text" name="ntp_server_<%= ${num}%>" placeholder="Enter NTP TimeServer" value="<% eval echo '$'ntp_server_${num} %>" class="form-control">
<%
done
...
%>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" name="web_ctl_port" id="web_ctl_port" placeholder="web ctl port" value="<% grep '^server.port' /usr/shellgui/shellguilighttpd/etc/lighttpd/lighttpd.conf | grep -Eo '[0-9]*$' %>">
								</div>
							</div>
